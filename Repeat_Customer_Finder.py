...
def main():
    ...
    logging.info('Length Names - ',len(li_name))
    ...
    logging.info('Phone Length - ',len(li_final_phone))
    ...
    logging.info('Final List Length- ',len(li_name_final))
    
    data1['name'] = li_name_final
    data1['phone'] = li_phone_final
    
    data1.to_excel('output_file1.xlsx',index = False)
    """
    ...
    for x in data['Shipping Address Phone']:
        if x in li1:
            ...
            li1.append(x)
    li2 = list(set(li2))
    logging.info('Length of Li2 - ',len(li2))
